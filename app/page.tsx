...
const ENTRIES = [
  ...
  },
  {
    ...
    title: '( 선택 ) 현재 소득 및 업종',
    placeholder: 'ex) 카페 알바 월 40만원 / IT업종 직장인 월 230만원',
  ...
  },
  {
    ...
    field: 'etc' as const,
    title: '기타 특이사항\n및 자기소개',
    placeholder: 'ex) 취미 밴드 활동에 월평균 10만원 지출 / 배달음식 줄이고 싶음',
  ...
  return (
    <div className="bg-af-yellow flex flex-col w-full">
      ...
      >
        ...
        <div className="relative flex flex-col gap-5 items-center text-center text-af-hero-text px-10 max-w-[600px] w-full text-shadow-hero">
          <h1
